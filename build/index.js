...
async function makeLocoRequestGraphql(query) {
    const headers = {
    ...
    try {
        ...
        return data; // Předpokládám, že data jsou v `data.data`
    }
    catch (error) {
...
server.tool("get-loco-products", "Returns information about the total number of products in pageInfo, ie. Due to the number you can use First: 1.", {
    /*identifier: z.string()
